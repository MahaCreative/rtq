...
export default function Jumbotron() {
    return (
        ...
        >
            <div className="absolute inset-0 bg-gradient-to-br from-red-600/40 via-red-800/40 bg-black0/40 bg-opacity-40"></div>
            ...
            <div className=" absolute transition-all duration-300 top-[30%] md:top-[20%] lg:top-[30%] left-[5%] inset-auto text-white">
                <h1 className="text-2xl font-bold font-Barlow leading-10 text-slate-500">
                    SELAMAT DATANG DI SITUS REMSI
                </h1>
                <p className="relative text-5xl font-kaushan font-extralight rounded-md inline text-slate-900">
                    RTQ WAHYU KUSUMA
                </p>
                <div className="my-4 relative inset-x-auto font-Barlow w-[80%] md:w-[70%] lg:w-[40%] p-2 rounded-lg shadow-md bg-slate-900/50 tracking-tighter">
                    <p>
