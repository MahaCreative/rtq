        ...
        >
            ...
            <div className="absolute md lg:top-[2%] lg:left-[5%] w-full">
                <div className="relative flex gap-3 items-center">
                    <div className="px-3 py-1 bg-red-500">
            ...
            <div className=" absolute transition-all duration-300 top-[30%] md:top-[20%] lg:top-[30%] left-[5%] inset-auto text-white">
                <h1 className="text-2xl font-bold font-Barlow leading-10">
                    SELAMAT DATANG DI SITUS REMSI
                </h1>
                <p className="relative text-5xl font-kaushan font-extralight px-2 rounded-md bg-red-500/50 inline">
                    RTQ WAHYU KUSUMA
                </p>
                <div className="my-4 relative inset-x-auto font-Barlow w-[80%] md:w-[70%] lg:w-[40%] p-2 rounded-lg shadow-md bg-red-100/50 tracking-tighter">
                    <p>
